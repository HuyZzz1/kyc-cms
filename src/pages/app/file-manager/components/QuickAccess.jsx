    ...
    <Block className="nk-fmg-quick-list">
      <BlockHead size="xs">
        <BlockBetween className="g-2">
          <BlockHeadContent>
            <BlockTitle tag="h6">Truy cập nhanh</BlockTitle>
          </BlockHeadContent>
          <BlockHeadContent>
            <a
              href="#toggle"
              ...
              className={`"link link-primary toggle-opt ${
                quickAccess === true ? "active" : ""
              }`}
            >
              <div className="inactive-text">Hiện</div>
              <div className="active-text">Ẩn</div>
            </a>
          </BlockHeadContent>
        </BlockBetween>
      </BlockHead>
      <div
        className={`toggle-expand-content ${
          quickAccess === true ? "expanded" : ""
        }`}
      >
        <div className="nk-files nk-files-view-grid">
          <div className="nk-files-list">
            {files.map((item, index) => (
              <div className="nk-file-item nk-file flex-grow-1" key={index}>
