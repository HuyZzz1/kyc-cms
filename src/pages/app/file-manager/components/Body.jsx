...
const FilesBody = ({
  ...
  const searchResult = [
    ...fileManager.files.filter(
      (item) =>
        !item.deleted &&
        item.name.toLowerCase().includes(fileManager.search.toLowerCase())
    ),
  ];
        ...
        <div className="nk-fmg-body-head d-none d-lg-flex">
          <div className="nk-fmg-search">
            ...
            <input
              ...
              placeholder="Tìm kiếm hồ sơ, tài liệu KYC..."
            ...
            <ul className="nk-block-tools g-3">
              <li>
                <UncontrolledDropdown>
                  ...
                  >
                    <Icon name="plus"></Icon> <span>Tạo</span>
                  </DropdownToggle>
                  <DropdownMenu end>
              ...
              <li>
                <Button color="primary" onClick={() => toggleUploadModal()}>
                  <Icon name="upload-cloud"></Icon> <span>Tải lên</span>
                </Button>
              </li>
            </ul>
          </div>
                    ...
                    <UncontrolledDropdown>
                      ...
                      >
                        <Icon
                          name={
                            viewOptions.filter(
                              (item) => item.value === fileManager.filesView
                            )[0].icon
                          }
                        ></Icon>
                      </DropdownToggle>
