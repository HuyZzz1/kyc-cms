              ...
              <div className="min-w-[900px] overflow-auto">
                <DataTableBody>
                  <DataTableHead>
                    ...
                    <DataTableRow>
                      <span className="text-nowrap">Người dùng</span>
                    </DataTableRow>
                    <DataTableRow size="mb">
                      <span className="text-nowrap">Loại giấy tờ</span>
                    </DataTableRow>
                    <DataTableRow size="md">
                      <span className="text-nowrap">Giấy tờ</span>
                    </DataTableRow>
                    <DataTableRow size="lg">
                      <span className="text-nowrap">Ngày nộp</span>
                    </DataTableRow>
                    <DataTableRow size="md">
                      <span className="text-nowrap">Trạng thái</span>
                    </DataTableRow>
                    <DataTableRow size="lg">
                      <span className="text-nowrap">Người duyệt</span>
                    </DataTableRow>
                          ...
                          <DataTableItem key={item.id}>
                            ...
                            <DataTableRow>
                              <div className="user-card">
                                <div className="user-info">
                                  ...
                                  <span>{item?.organization?.email}</span>
                                </div>
                              </div>
                            </DataTableRow>
                            <DataTableRow>
                            ...
                            <DataTableRow className="nk-tb-col-tools">
                              <ul className="nk-tb-actions gx-1">
                                ...
                                {item.status ===
                                KYC_STATUS.REJECTED ? null : item.status ===
                                  KYC_STATUS.APPROVED ? (
                                  <li
                                    className="nk-tb-action-hidden"
      ...
      >
        <ModalBody>
          ...
          <div className="nk-tnx-details mt-sm-3">
            <Row className="gy-3">
              <Col lg={24}>
                <span className="sub-text">Tổ chức</span>
              ...
              <Col lg={6}>
                ...
                <Badge
                  color={
                    detail.status === KYC_STATUS.APPROVED
                      ? "success"
                      : detail.status === KYC_STATUS.PENDING
                      ? "info"
                      : "danger"
                  }
                  size="md"
